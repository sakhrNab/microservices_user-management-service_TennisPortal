...
urlpatterns = [
    ...
    # path('api/my-profile/', views.UserAPI.as_view(), name='user'),
    ...
    # path('api/filter-available-users/', views.FilterUsersAPIView.as_view(), name='filter_user'),
    ...
    # path('api/delete-user/<str:username>/', views.DestroyUserAPIView.as_view(), name="delete_user"),
    # path('api/delete-user/', views.DeleteAccount.as_view(), name="delete_account"),
    # path('api/filter-by-id/', views.FilterUsersByIDAPIView.as_view(), name="search_by_id"),
