...
class ProfileFactory(factory.django.DjangoModelFactory):
    ...
    skill_level = factory.LazyAttribute(lambda x: f"novice")
    game_type = factory.LazyAttribute(lambda x: f"tennis")
    country = factory.LazyAttribute(lambda x: faker.country_code())
    city = factory.LazyAttribute(lambda x: faker.city())
    region = factory.LazyAttribute(lambda x: f"Berlin")
    zip_code = factory.LazyAttribute(lambda x: f"")
    is_opponent = True
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    email = factory.LazyAttribute(lambda x: f"zacki@gmail.com")
